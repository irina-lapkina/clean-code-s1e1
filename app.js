...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("incomplete-tasks-edit-mode");
  //If class of the parent is .incomplete-tasks-edit-mode
  if(containsClass){
    //switch to .editmode
  ...
  listItem.classList.toggle("incomplete-tasks-edit-mode");
};
